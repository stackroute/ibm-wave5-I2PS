...
export class RegistrationServiceService {
  ...
  addServiceProvider(value):any{
    this.http.post("http://13.232.118.81:8077/api/v1/serviceprovider",value).subscribe(console.log);
  ...
  addInnovatorProfile(value):any{
    this.http.post("http://l13.232.118.81:8094/api/v1/innovatorprofile",value).subscribe();
    console.log("came");
