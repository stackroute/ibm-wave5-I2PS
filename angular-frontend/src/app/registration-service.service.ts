...
export class RegistrationServiceService {
  ...
  getServiceProvider():any{
    console.log("getting")
    return this.http.get("http://13.232.118.81/api/v1/serviceproviders");
  }

  addServiceProvider(value):any{
    this.http.post("http://13.232.118.81/api/v1/serviceprovider",value).subscribe(console.log);
  ...
  getByEmailIdForServiceProvider(emailId):any{
    ...
    return this.http.get(`http://13.232.118.81/api/v1/getByEmailId/${emailId}`);
  }

  getInnovatorProfile():any{
    console.log("gettinginnovatorprofile ")
    return this.http.get("http://13.232.118.81/api/v1/innovatorprofiles");

  }
  addInnovatorProfile(value):any{
    this.http.post("http://13.232.118.81/api/v1/innovatorprofile",value).subscribe();
    console.log("came");
  ...
  getByEmailIdForInnovatorProfile(emailId):any{
    console.log("in getbyemail of reg service "+emailId);
    return this.http.get(`http://13.232.118.81/api/v1/innovatorprofile/${emailId}`);
  }
